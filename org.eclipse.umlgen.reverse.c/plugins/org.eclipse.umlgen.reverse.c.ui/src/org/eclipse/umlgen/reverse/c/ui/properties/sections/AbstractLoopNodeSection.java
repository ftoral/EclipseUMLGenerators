...
/**
 * Section with common behaviors and implementations of main features expected
 * for sections related to {@link LoopNode}.
 * 
 * Creation : 22 june 2010<br>
 * 
 * @author <a href="mailto:sebastien.gabel@c-s.fr">Sebastien GABEL</a>
 */
// FIXME MIGRATION reference to org.topcased.tabbedproperties
public abstract class AbstractLoopNodeSection extends
		AbstractStringWithButtonSection {
	...
	protected void createCommand(Object oldValue, Object newValue) {
		...
		if (!equals) {
			...
			cc.appendIfCanExecute(SetCommand.create(editingDomain,
					getOpaqueAction(),
					UMLPackage.eINSTANCE.getNamedElement_Name(), newValue));
	 ...
	 * @param cc
	 *            The compound command in which all the add/set commands must be
	 *            stored.
	 */
	...
	/**
	 * Defines the opaque action access policy depending of the context. Clients
	...
	/**
	 * Creates the new opaque action when necessary. Clients must implement this
	 * method.
	 * 
