...
public class TestTypeDef1 extends AbstractTest {
	...
	public void testSimpleAliasInC() throws CoreException, InterruptedException {
		...
		IProject project = createIProject("testaliasBuiltinTypeC",
				new NullProgressMonitor());

		IFile iFile = createIFile(project, new Path("aliasBuiltin.c"),
				new NullProgressMonitor());
		...
		testModel(project,
				"/resource/structural/addition/typedef/alias/aliasBuiltinTypeC.uml");
	}

	@Test
	public void testSimpleAliasInH() throws CoreException, InterruptedException {

		IProject project = createIProject("testaliasBuiltinTypeH",
				new NullProgressMonitor());

		IFile iFile = createIFile(project, new Path("aliasBuiltin.h"),
				new NullProgressMonitor());
		...
		testModel(project,
				"/resource/structural/addition/typedef/alias/aliasBuiltinTypeH.uml");
	}

	@Test
	public void testPointerInC() throws CoreException, InterruptedException {

		IProject project = createIProject("testTypeDefPointerC",
				new NullProgressMonitor());
		...
		testModel(project,
				"/resource/structural/addition/typedef/pointer/TypeDefPointerC.uml");
	}

	@Test
	public void testPointerInH() throws CoreException, InterruptedException {

		IProject project = createIProject("testTypeDefPointerH",
				new NullProgressMonitor());
		...
		testModel(project,
				"/resource/structural/addition/typedef/pointer/TypeDefPointerH.uml");
	}
