...
public class StructuralBuilder {
	...
	public void build(ITranslationUnit translationUnit, boolean fullBuild)
		...
		// declarations =
		// Collections2.filter(ImmutableList.of(declarationsArray), new
	...
	private void addIncludes(ITranslationUnit translationUnit,
		...
		// Collections2.filter(ImmutableList.of(includesArray), new
		// SameFileLocation(ast));
	...
	private void addMacros(ITranslationUnit translationUnit,
		...
		// Collections2.filter(ImmutableList.of(macros), new
		// SameFileLocation(ast));
	...
	private void addIfNDef(ITranslationUnit translationUnit,
		...
		// SameFileLocation(ast));
		Collection<IASTPreprocessorStatement> filteredPreprocStmts = Collections.EMPTY_LIST;
